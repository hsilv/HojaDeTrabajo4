                ...
                switch (respuesta) {
                    ...
                    while(lectura.hasNextLine())
                    {
                        try {
                            ...
                            System.out.println(i + ".\t\t" + linea + "\t\t" + calc.Evaluar(cadena, 1));
                        } catch (Exception e) {
                    ...
                    while(lectura.hasNextLine())
                    {
                        try {
                            ...
                            System.out.println(i + ".\t\t" + linea + "\t\t" + calc.Evaluar(cadena, 2));
                        } catch (Exception e) {
                            System.out.println(i + ".\t\t" + linea + "\t\tLa expresion no esta escrita correctamente.");
                        }
                        i++;
                    ...
                    if(respuesta == 1)
                    {
                        ...
                        while(lectura.hasNextLine())
                        {
                            try {
                                ...
                                System.out.println(i + ".\t\t" + linea + "\t\t" + calc.Evaluar(cadena, 3));
                            } catch (Exception e) {
                                System.out.println(i + ".\t\t" + linea + "\t\tLa expresion no esta escrita correctamente.");
                            }
                            i++;
                    ...
                    else
                    {
                        ...
                        while(lectura.hasNextLine())
                        {
                            try {
                                ...
                                System.out.println(i + ".\t\t" + linea + "\t\t" + calc.Evaluar(cadena, 4));
                            } catch (Exception e) {
                                System.out.println(i + ".\t\t" + linea + "\t\tLa expresion no esta escrita correctamente.");
                            }
                            i++;
